...
%   contains the stability and control derivatives of model by M. Burston, 
% “Reverse engineering of a fixed wing unmanned aircraft 6-dof model based on laser
...
MAV.Jy   = 1.135;
MAV.Jz   = 1.759;
MAV.Jxz  = 0.120;% change to see roll yaw coupling

% initial conditions
MAV.pn0    = -150;     % initial North position
MAV.pe0    = 0;     % initial East position
MAV.pd0    = -100;  % initial Down position (negative altitude)
MAV.u0     = 8;%17;     % initial velocity along body x-axis
...
e = [MAV.phi0  MAV.theta0  MAV.psi0 ]; % ZYX sequence check if its valid 
e = eul2quat(e);
